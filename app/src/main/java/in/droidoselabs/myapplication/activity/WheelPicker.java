...
import in.droidoselabs.myapplication.interfaces.IDebug;
import in.droidoselabs.myapplication.interfaces.IWheelPicker;
...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        int idData = a.getResourceId(R.styleable.WheelPicker_wheel_data, 0);
            ...
            mData = Arrays.asList(a.getResources().getStringArray(R.array.WheelArrayDefault));
    ...
    public interface SetData{
       String[] setData(String[] arrayList);
    }
}
